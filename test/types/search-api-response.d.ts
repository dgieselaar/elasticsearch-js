...
import { Context, RequestBody } from '../../lib/Transport';
import Aggregation from "./elastic-client-generator";
...
// { // Aggregation Request
//   aggs?: { // AggregationMap
//     name_of_aggregation: { // Aggregation (& AggregationRequest)
//       terms: {
//         field: 'field_name',
//       },
//       aggs: { 
...
type AggregationTypeName = Exclude<keyof Aggregation.AggregationContainer, 'aggs' | 'aggregations'>;
...
type Aggregation = ExclusiveUnion<
  Unionize<{
    [TBucketingAggregationName in BucketingAggregationTypeName]: Aggregation.AggregationContainer[TBucketingAggregationName]
  }> & Partial<UnionToIntersection<AggregationRequest>>,
  Unionize<{
    [TBucketingAggregationName in NonBucketingAggregationTypeName]: Aggregation.AggregationContainer[TBucketingAggregationName]
  }>,
...
export type SearchRequestBody = AggregationRequest & Partial<Record<'size' | 'query' | 'sort' | 'fields' | '_source', any>>;
export type SearchApiResponse<TRequestBody extends SearchRequestBody, TDocument = unknown> =
  TRequestBody extends AggregationRequest ? WrapAggregationResponse<SearchResponseOf<TRequestBody, TDocument>> : { aggregations?: InvalidAggregationRequest }
